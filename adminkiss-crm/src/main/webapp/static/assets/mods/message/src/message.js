    ...
    (function ($) {
        $.SmartMessageBox = function (settings, callback) {
            ...
            if (isIE8orlower() == 0) {
                ...
                audioElement.setAttribute('src', SoundPath + 'sound/messagebox.mp3');
                $.get();
            ...
            if (settings.sound === true) {
                if (isIE8orlower() == 0) {
                    ...
                    if (navigator.userAgent.match('Firefox/'))
                        audioElement.setAttribute('src', SoundPath + 'sound/bigbox.ogg');
                    else
                        audioElement.setAttribute('src', SoundPath + 'sound/bigbox.mp3');
        ...
        $.smallBox = function (settings, callback) {
            ...
            if (settings.sound === true) {
                if (isIE8orlower() == 0) {
                    var audioElement = document.createElement('audio');
                    if (navigator.userAgent.match('Firefox/'))
                        audioElement.setAttribute('src', SoundPath + 'sound/smallbox.ogg');
                    else
                        audioElement.setAttribute('src', SoundPath + 'sound/smallbox.mp3');
